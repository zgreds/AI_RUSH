...
def independent_pair(a1, a2):
    ...
    """
    "*** YOUR CODE HERE ***"
    a1_pre = set(a1.get_pre())
    a2_pre = set(a2.get_pre())

    a1_add = set(a1.get_add())
    a2_add = set(a2.get_add())

    a1_delete = set(a1.get_delete())
    a2_delete = set(a2.get_delete())

    cond1 = not (a1_add.intersection(a2_delete) or a2_add.intersection(a1_delete))
    cond2 = not (a1_pre.intersection(a2_delete) or a2_pre.intersection(a1_delete))
    # print("independent_pair: ", cond1 and cond2)
